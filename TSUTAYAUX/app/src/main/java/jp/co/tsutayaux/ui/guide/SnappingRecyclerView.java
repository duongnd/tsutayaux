...
public class SnappingRecyclerView extends RecyclerView {
        ...
        addOnScrollListener(new OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == SCROLL_STATE_TOUCH_SCROLL) {
                    /**
                     * if scroll was initiated already, it would probably be a
                     * tap
                     **/
                    /**
                     * if scroll was not initiated before, this is probably a
                     * user scrolling
                     **/
                    if (!_scrolling) {
                        _userScrolling = true;
                    ...
                    /**
                     * if user is the one scrolling, snap to the view closest to
                     * center
                     **/
                    if (_userScrolling) {
                        scrollToView(getCenterView());
                    ...
                    /**
                     * if idle, always check location and correct it if
                     * necessary, this is just an extra check
                     **/
    ...
    private void notifyListener() {
        ...
        /**
         * if there is a listener and the index is not the same as the currently
         * selected position, notify listener
         **/
     ...
     * 
     * @param orientation LinearLayoutManager.HORIZONTAL or
    ...
    /**
     * Enable downscaling of views which are not focused, based on how far away
    ...
    /**
     * Adds the margins to a childView so a view will still center even if it's
     * only a single child
     * 
    ...
    private void setMarginsForChild(View child) {
        ...
        /**
         * if sdk minimum level is 18, check if view isn't undergoing a layout
         * pass (this improves the feel of the view by a lot)
         **/
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        /**
         * if touch events are being spammed, this is due to user scrolling
         * right after a tap, so set userScrolling to true
         **/
    ...
    private View getChildClosestToLocation(int location) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            /**
             * if child center is closer than previous closest, set it as
             * closest child
             **/
